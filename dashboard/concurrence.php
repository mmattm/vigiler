                        ...
                        <div class="panel-body">
                            <div class="flot-chart">
                                <div class="flot-chart-content" id="flot-pie-chart">
                                    <h3 style="margin-top:-5px;">Keywords <i class="fa fa-key fa-1x"></i></h3>
                                    <p>Mercedes, Benz</p>
                                    <h3>Content <i class="fa fa-file-text-o"></i></h4>
                                    ...
                                    <h3>Source <i class="fa fa-globe"></i></h4>
                                    <p>Twitter</p>
                                    <h3>Link <i class="fa fa-level-up"></i></h4>
                                    <p> <a href="http:\/\/t.co\/X9rA5JOFkB">http:\/\/t.co\/X9rA5JOFkB</a> </p>
                                    <h3>Type <i class="fa fa-flag"></i></h4>
                                    <p>
